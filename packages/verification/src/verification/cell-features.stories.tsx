...
export const Clipboard = () => (
  <Compare
    settings={{
      ...
      columns: [{}, { type: 'numeric' }, { type: 'numeric' }, { copyable: false }],
    }}
    data={[
...
export const Comments = () => (
  <Compare
    settings={{
      ...
      contextMenu: true,
      cell: [
        { row: 0, col: 2, comment: { value: 'Blocked on the API review — chase Ana on Monday.' } },
        { row: 1, col: 1, comment: { value: 'James is on leave until the 14th.' } },
      ],
    }}
    data={[
...
export const ReadOnlyCells = () => (
  <Compare
    settings={{
      ...
      cells: (row, col) => (row === 1 && col !== 1 && col !== 3 ? { readOnly: true } : {}),
    }}
    data={[
...
export const TextAlignment = () => (
  <Compare
    ...
    data={[
      ['Northwind', 'Northwind', 'Northwind', 'A longer line of text so that justify has something to spread'],
      ['Contoso', 'Contoso', 'Contoso', 'A longer line of text so that justify has something to spread'],
      ['Fabrikam', 'Fabrikam', 'Fabrikam', 'A longer line of text so that justify has something to spread'],
    ]}
